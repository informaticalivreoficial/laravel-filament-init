                ...
                <form id="contact-form" action="" method="post" class="j_formsubmit" autocomplete="off">
                    ...
                    <div class="row form_hide">                                
                        <div class="col-3">                                    
                            ...
                            <select class="check_hospedagem" name="num_adultos" style="margin-left: 15px;margin-top: 20px;margin-bottom:20px;">                                        
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label title="Crianças de 0 a 5 anos">Crianças de 0 a 5 anos</label>
